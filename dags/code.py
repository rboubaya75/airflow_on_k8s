...
with DAG(
    ...
    """
    def sftp_file_sensor():
        logging.info("Checking for new zip files in SFTP directory.")
        ...
        return bool(zip_files)

    wait_for_files = PythonSensor(
        task_id='wait_for_files',
        python_callable=sftp_file_sensor,
        mode='reschedule',
